    ...
    <div class="container">
        ...
        <div class="row text-center align-items-center">
            <div class="col-12 wow fadeInUp" data-wow-delay="0.3s">
                <span class="d-inline-block me-4 mb-4"><i class="fa fa-circle fs-4 me-1 align-middle" style="color: #DC3545;"></i>{{ __('miscellaneous.inner_page.hospitals.legend.data1') }}</span>
                <span class="d-inline-block me-4 mb-4"><i class="fa fa-circle fs-4  me-1 align-middle" style="color: #4FB9A9;"></i>{{ __('miscellaneous.inner_page.hospitals.legend.data3') }}</span>
                <span class="d-inline-block me-4 mb-4"><i class="fa fa-circle fs-4  me-1 align-middle"  style="color: #F5A348;"></i>{{ __('miscellaneous.inner_page.hospitals.legend.data2') }}</span>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-6 col-sm-12 wow fadeInUp" data-wow-delay="0.1s">
                <div class="card border border-default overflow-hidden shadow-0">
                    <div class="card-header bg-light">
                        <h3 class="h3 m-0 fw-normal" style="color: #DC3545;">Bandalungwa</h3>
                    </div>
                    <ul class="list-group list-group-flush rounded-0">
                        <li class="list-group-item px-4 py-3">
                            <h5 class="h5 mb-1 fw-bold " style="color: #4FB9A9;">LIBIKISI</h5>
                            <h6 class="h6 mb-3 " style="color: #F5A348;">Bisengo</h6>
                        ...
                        <li class="list-group-item px-4 py-3">
                            <h5 class="h5 mb-1 fw-bold" style="color: #4FB9A9;">RIVIERA CLINIC</h5>
                            <h6 class="h6 mb-3" style="color: #F5A348;">Kasa-Vubu</h6>
                            <p class="mb-1 fw-light">
