                                                            ...
                                                            <div class=" col-lg-12 col-sm-12">
                                                                <div class="ibox" id="tab-smlGroup">
                                                                    <div class="ibox-title">
                                                                        <h5>Ce formulaire vous permet de poster un
                                                                            bureau</h5>
                                                                    </div>
                                                                    <div class="ibox-content">
                                                                        <div class='row'>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <label>Nom du bureau
                                                                                                (Francais)</label>
                                                                                            <input type="text"
                                                                                                value="{{ isset($bureau) ? $bureau->getTranslation('titre', 'fr') : '' }}"
                                                                                                class="form-control"
                                                                                                name='titre'>
                                                                                        </div>
                                                                                        <div
                                                                                            ...
                                                                                            <input type="text"
                                                                                                class="form-control"
                                                                                                name='titre_en'
                                                                                                value="{{ isset($bureau) ? $bureau->getTranslation('titre', 'en') : '' }}">
                                                                                        </div>
                                                                                        <div
                                                                                            class="col-sm-6  form-group ">
                                                                                            ...
                                                                                            <input type="text"
                                                                                                placeholder="Le titre"
                                                                                                value="{{ isset($bureau) ? $bureau->getTranslation('adresse', 'fr') : '' }}"
                                                                                                class="form-control"
                                                                                                name='adresse'>
                                                                                        </div>
                                                                                        <div
                                                                                            ...
                                                                                            <input type="text"
                                                                                                ...
                                                                                                class="form-control"
                                                                                                name='adresse_en'
                                                                                                value="{{ isset($bureau) ? $bureau->getTranslation('adresse', 'en') : '' }}">
                                                                                        </div>
                                                                                        <div
                                                                                            class="col-sm-6  form-group ">
                                                                                            ...
                                                                                            <input type="text"
                                                                                                class="form-control"
                                                                                                name='telephone'value="{{ isset($bureau) ? $bureau->telephone : '' }}">
                                                                                        </div>
                                                                                        <div
                                                                                            class="col-sm-6  form-group ">
                                                                                            <label>Email </label>
                                                                                            <input type="text"
                                                                                                class="form-control"
                                                                                                name='email'
                                                                                                value="{{ isset($bureau) ? $bureau->email : '' }}">
                                                                                        </div>
                                                                                        <div
                                                                                            class="col-sm-6  form-group ">
                                                                                            ...
                                                                                            <input type="text"
                                                                                                class="form-control"
                                                                                                name='physique'
                                                                                                value="{{ isset($bureau) ? $bureau->physique : '' }}">
                                                                                        </div>
                                                                                        <div
                                                                                            class="col-sm-6  form-group">
                                                                                            <label>Adresse physique
                                                                                            ...
                                                                                            <input type="text"
                                                                                                class="form-control"
                                                                                                name='physique_en'
                                                                                                value="{{ isset($bureau) ? $bureau->getTranslation('physique', 'en') : '' }}">
                                                                                        </div>
                                                                                        <div
                                                                                            class="col-sm-12 form-group">
                                                                                            <label>Photo</label>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <label>Présentation
                                                                                                (Français)</label>
                                                                                            <textarea name="detail" class="summernote" rows="12" id=''>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <label>Présentation
                                                                                                (Anglais)</label>
                                                                                            <textarea name="detail_en" class="summernote" rows="12" id=''>
                                                                                                {!! isset($bureau) ? $bureau->getTranslation('detail', 'en') : '' !!}
                                                                                        </textarea>
                                                                                        </div>
                                                                                        <div
                                                                                            class="col-sm-offset-3  col-sm-9 form-group">
                                                                                            <div
