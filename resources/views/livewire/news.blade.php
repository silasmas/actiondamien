              ...
              <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                  <div class="input-group">
                      ...
                      <span class="input-group-text p-0 border-danger overflow-hidden"
                          ...
                          <button class="btn btn-danger px-4 rounded-0" style="height: 60px;"><i
      ...
      <div class="container py-3">
          <div class="row">
              ...
              <div class="col-lg-7 col-sm-6 wow fadeInUp paragraph-ellipsis" data-wow-delay="0.3s">
                  ...
                  <h5 class="h5 text-danger fw-bold text-truncate">
                      <a href="{{ route('news_details', ['id' => 2]) }}" class="text-danger">Andy BIESE y a
                          représenté Action Damien à la 1ère édition du Africell Congo River Marathon.</a>
                  </h5>
                  <p class="mb-0 paragraph">
                      La 1ère édition du Africell Congo River Marathon a eu lieu à Kinshasa le week-end le 29 août
                      2021. Il s'agit d'un marathon complet, un semi-marathon, 10km Fun Run pour permettre au plus
      ...
      <div class="container py-3">
          <div class="row">
              ...
              <div class="col-lg-7 col-sm-6 wow fadeInUp paragraph-ellipsis" data-wow-delay="0.3s">
                  ...
                  <h5 class="h5 text-danger fw-bold text-truncate">
                      <a href="{{ route('news_details', ['id' => 3]) }}" class="text-danger">L'engagement du
                          Ministre de la Santé - Lèpre.</a>
                  </h5>
                  <p class="mb-0 paragraph">
      ...
      <div class="container py-3">
          <div class="row">
              ...
              <div class="col-lg-7 col-sm-6 wow fadeInUp paragraph-ellipsis" data-wow-delay="0.3s">
                  ...
                  <p class="mb-0 paragraph">
                      Isadora De Backer qui est venu expressément depuis la Belgique pour nous donner cours à ce sujet
                      pendant pratiquement 10 jours
                  </p>
                  <p class="mb-0">
                      <a class="btn fw-bold py-2 ps-0 pe-3 rounded-0"
                          href="{{ route('news_details', ['id' => 4]) }}"
                          style="color: black; border-bottom: 3px rgb(214, 63, 63) solid;">
                          {{ __('miscellaneous.inner_page.news.link') }}
                      </a>
                  </p>
      ...
      <div class="container py-3">
          <div class="row">
              ...
              <div class="col-lg-7 col-sm-6 wow fadeInUp paragraph-ellipsis" data-wow-delay="0.3s">
                  ...
                  <p class="mb-0 paragraph">
                      Projet Papoose - Suite de distribution des vivres du mois d'aout, à Kinshasa. Mall de pott
                      détécté chez une enfant de moins de 10 ans.
                  </p>
                  <p class="mb-0">
                      <a class="btn fw-bold py-2 ps-0 pe-3 rounded-0"
                          href="{{ route('news_details', ['id' => 5]) }}"
                          style="color: black; border-bottom: 3px rgb(214, 63, 63) solid;">
                          {{ __('miscellaneous.inner_page.news.link') }}
                      </a>
                  </p>
  ...
  <div class="container-xxl py-5 border-top border-default">
      <div class="container py-3">
          <div class="row">
              <div class="col-lg-5 col-sm-6 mb-lg-0 mb-4 wow fadeInUp" data-wow-delay="0.1s">
                  <div class="bg-image overflow-hidden h-100" style="max-height: 16rem; border-radius: 1.2rem;">
                      <img src="{{ asset('assets/img/photo/16463026882.jpeg') }}" alt=""
                          class="img-fluid">
                      <div class="mask"></div>
                  </div>
              </div>
              ...
              <div class="col-lg-7 col-sm-6 wow fadeInUp paragraph-ellipsis" data-wow-delay="0.3s">
                  ...
                  <h5 class="h5 text-danger fw-bold text-truncate">
                      <a href="{{ route('news_details', ['id' => 6]) }}" class="text-danger">Visite de
                          l'Ambassadeur de Belgique en RDC, Mr Stefan INDEKEU au CEDA</a>
                  </h5>
                  <p class="mb-0 paragraph">
      ...
      <div class="container py-3">
          <div class="row">
              ...
              <div class="col-lg-7 col-sm-6 wow fadeInUp paragraph-ellipsis" data-wow-delay="0.3s">
                  ...
                  <h5 class="h5 text-danger fw-bold text-truncate">
                      <a href="{{ route('news_details', ['id' => 7]) }}" class="text-danger">La visite du CEDA par
                          Mr. Jo INDEKEU, diffusé à la RTNC</a>
                  </h5>
                  <p class="mb-0 paragraph">
                      Visite de l'ambassadeur de la Belgique en RD Congo, Mr. Jo INDEKEU & du Ministre Conseiller Mr.
                      Stefan MEERSCHAERT, à la remise officielle de la nouvelle ambulance au CEDA.
