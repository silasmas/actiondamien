                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="client-status">
                                                                    <a href="{{ $tem->id }}" id='deletePortofolio'
                                                                        onclick="event.preventDefault();deleter({{ $tem->id }},'delSupport')"><span
                                        ...
                                        <div class="client-detail">
                                            <div class="full-height-scroll">
                                                <form role="form" id="formTemoignagePhoto" method="POST"
                                                        action="{{ route('editeImageSupport') }}" class='form-group'
                                                ...
                                                onSubmit="event.preventDefault();add(this,'#tab-rubrique','editSupport')">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-12 form-group ">
                                                            ...
                                                            <input type="text" placeholder="Titre"
                                                                ...
                                                                value="{{ $se->getTranslation('titre1', 'fr') }}" required>
                                                        ...
                                                        <div class="col-lg-12 form-group ">
                                                            ...
                                                            <input type="text" placeholder=" Titre"
                                                                ...
                                                                value="{{ $se->getTranslation('titre1', 'en') }}"required>
                                                        </div>
                                                        <div class="col-lg-12 form-group ">
                                                            <label>Titre (Lingala)</label>
                                                            <input type="text" placeholder="Titre"
                                                                class="form-control" name='h1_ln'   
                                                                value="{{ $se->getTranslation('titre1', 'ln') }}"required>
                                                        </div>
                                                        <div class="col-lg-12 form-group ">
                                                            <label>Texte appel (Français)</label>
                                                            <input type="text" placeholder="Titre"
                                                                class="form-control" name='txtNumber_fr'   
                                                                value="{{ $se->getTranslation('txtphone', 'ln') }}"required>
                                                        </div>
                                                        <div class="col-lg-12 form-group ">
                                                            <label>Texte appel  (Anglais)</label>
                                                            <input type="text" placeholder="Titre"
                                                                class="form-control" name='txtNumber_en'   
                                                                value="{{ $se->getTranslation('txtphone', 'ln') }}"required>
                                                        </div>
                                                        <div class="col-lg-12 form-group ">
                                                            <label>Texte appel  (Lingala)</label>
                                                            <input type="text" placeholder="Titre"
                                                                class="form-control" name='txtNumber_ln'   
                                                                value="{{ $se->getTranslation('txtphone', 'ln') }}"required>
                                                        </div>
                                                        <div class="col-lg-12 form-group ">
