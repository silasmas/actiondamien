                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="client-status">
                                                                    <a href="{{ $tem->id }}" id='deletePortofolio'
                                                                        onclick="event.preventDefault();deleter({{ $tem->id }},'delHopital')"><span
                                        ...
                                        <div class="client-detail">
                                            <div class="full-height-scroll">
                                                <form role="form" id="formTemoignagePhoto" method="POST"
                                                        action="{{ route('editeImageHopital') }}" class='form-group'
                                                ...
                                                onSubmit="event.preventDefault();add(this,'#tab-rubrique','edithopital')">
                                                    @csrf
                                                    <div class="row">
