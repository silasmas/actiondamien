                                            ...
                                            <tr>
                                                <td class="client-avatar">
                                                    <a data-toggle="tab" href="#portofolio-{{ $tem->id }}"
                                                        class="client-link">
                                                        <img alt="image" src="{{ asset('storage/' . $tem->image) }}">
                                                    </a>
                                                </td>
                                                <td>
                                                    <a data-toggle="tab" href="#portofolio-{{ $tem->id }}"
                    ...
                    <div id="portofolio-{{ $se->id }}" class="tab-pane {{ $loop->first ? 'active' : '' }}">
                        <div class="row m-b-lg">
                            <div class="col-lg-12 text-center ">
                                ...
                                <div class="m-b-sm">
                                    <img alt="image" class="" src="{{ asset('storage/' . $se->image) }}" height="200"
                                        width="350">
                                </div>
                            </div>
                        </div>
                        <div class="client-detail">
                            <div class="full-height-scroll">
                                <form role="form" id="formTemoignagePhoto" method="POST"
                                    action="{{ route('editeImageNews') }}" class='form-group'
                                ...
                                <form method="POST" class="form-group" action="{{ route('editeNews') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-sm-12 col-lg-12 form-group hidden">
                                            <input type="text" class="form-control" value="{{ $se->rubrique_id }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 form-group ">
                                            ...
                                            <input type="text" hidden value="{{ $se->getTranslation('titre', 'fr') }}"
                                                name="idslide" />
                                        ...
                                        <div class="col-lg-12 form-group ">
                                            ...
                                            <input type="text" placeholder=" Titre" class="form-control"
                                                value="{{ $se->getTranslation('titre', 'en') }}" name='h1_en' required>
                                        </div>
                                        <div class="col-lg-12 form-group ">
                                            <label>Titre
                                                (Lingala)</label>
                                        ...
                                        <div class="col-lg-12 form-group ">
                                            <label>Vidéo</label>
                                            <input type="text" placeholder="Vidéo" class="form-control"
                                                value="{{ $se->video }}" name='video'>
                                        </div>
