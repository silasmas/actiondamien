                            ...
                            <div class="row justify-content-sm-start justify-content-center text-sm-start">
                                <div class="col-lg-7 pt-4 ps-sm-5">
                                    <h1 class="display-4 fw-normal text-white mb-4 animated slideInDown"
                                        ...
                                        {{ __('miscellaneous.slides.title_1a') }}<br>{{ __('miscellaneous.slides.title_1b') }}<span
                                            style="font-style: italic; color: #58b8a7;">{{ __('miscellaneous.slides.title_1c') }}</span>
                                    </h1>
                            ...
                            <div class="row justify-content-sm-start justify-content-center text-sm-start">
                                <div class="col-lg-7 pt-4 ps-sm-5">
                                    ...
                                    <a class="btn btn-green py-2 px-3 animated slideInDown"
                                        ...
                                        <div class="d-inline-flex btn-sm-square bg-white text-green rounded-circle ms-2">
                                            <i class="fa fa-arrow-right"></i>
                                        </div>
                                    </a>
                                </div>
        ...
        <div class="container-lg container-fluid px-sm-4 py-5">
            <div class="row g-0 text-sm-start text-center ">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="wow fadeInUp" data-wow-delay="0.5s" style="max-width: 600px;">
                                ...
                                <h1 class="display-6 mb-sm-5 mb-4">{{ __('miscellaneous.national_cover.description1') }}
                                    <span class="text-danger">{{ __('miscellaneous.national_cover.description2') }}</span>
                                </h1>
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-12 pt-sm-0 pt-4">
                    <div class="bg-image">
                        <img src="{{ asset('assets/img/photo/map-markers2-2022.png') }}" alt="markers"
                            class="img-fluid">
                        <div class="mask"></div>
                    </div>
                </div>
                ...
                <div class="four col-sm-4 mb-4 wow fadeInUp" data-wow-delay="1.3s">
                    <div class="counter-box px-4 bg-secondary border border-yellow">
                        ...
                        @switch($s->titre2)
                            ...
                            @default
                        @endswitch
                        <span class="counter text-green">200000</span>
                        ...
                        @forelse ($stat2 as $st)
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="service-item bg-white text-center h-100 p-4 py-xl-5 px-xl-4">
                                    @switch($st->maladie)
                                        @case('Lèpre')
                                            <img class="img-fluid mb-4" src="{{ asset('assets/img/photo/lepre.png') }}"
                                                alt="">
                                        @break
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                                <div class="bg-image shadow">
                                    ...
                                    <img src="{{ asset('assets/img/photo/report.png') }}" alt=""
                ...
                <div class="container-xxl pb-5">
                    <div class="container">
                        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                            <div class="d-inline-block rounded-pill bg-secondary text-danger py-1 px-3 mb-3"> @lang('miscellaneous.inner_page.actualite.libelle')
                            </div>
