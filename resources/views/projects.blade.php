...
<div class="container-fluid page-header wow fadeIn" data-wow-delay="0.1s"
    ...
    url({{ asset('storage/'.$detail->photo) }}) center center no-repeat; background-size: cover;">
    <div class="container text-center">
        <h1 class="display-4 mb-4 text-white animated slideInDown">{{ $detail->titre }}
        </h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a class="text-white" href="./">{{ __('miscellaneous.main_menu.home') }}</a>
                </li>
                <li class="breadcrumb-item"><a class="text-white" href="{{ route('projects') }}">{{
                        __('miscellaneous.main_menu.projects') }}</a></li>
                <li class="breadcrumb-item text-yellow active" aria-current="page">{{ $detail->intituler }}</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="container">
        <div class="row g-lg-5">
            <div class="col-lg-8 mb-4 border-bottom border-default wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="h1 mb-4 fw-bold">{{ $detail->titre }}</h1>
                <p class="lead mb-sm-5 mb-4 fw-bold">
                <pre class="fs-5">{!! $detail->text  !!}</pre>
                </p>
            </div>
            <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="row mb-lg-4 mb-5">
                    ...
                    <div class="col-lg-7 col-sm-8 col-12 paragraph-ellipsis">
                        ...
                        <a href="{{ route('projects_details', ['id' => $p->id]) }}">
                            <p class="m-0 small" style="color: #999;">{{ $p->intituler }}</p>
                            <p class="m-0 fw-bold text-blue text-truncate">{{ $p->titre }}</p>
                            ...
                            <p class="mb-0 d-lg-none d-sm-inline-block">
                                <a class="btn fw-bold pt-1 pb-2 ps-0 pe-3 rounded-0"
                                    href="{{ route('projects_details', ['id' => $p->id]) }}"
            ...
            <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                <div class="input-group">
                    <input type="text" class="form-control"
                        aria-label="{{ __('miscellaneous.inner_page.projects.search') }}"
                        placeholder="{{ __('miscellaneous.inner_page.projects.search') }}"
                    ...
                    <span class="input-group-text d-sm-inline-block d-none p-0 border-0 bg-light overflow-hidden">
                        <select class="form-select rounded-0"
                            aria-label="{{ __('miscellaneous.inner_page.projects.choose_year') }}"
                            style="background-color: transparent; padding-top: 1.15rem; padding-bottom: 1.1rem;">
                            <option class="small" selected disabled>{{
                                __('miscellaneous.inner_page.projects.choose_year') }}</option>
                    ...
                    <span class="input-group-text p-0 border-blue overflow-hidden"
                        style="border-end-end-radius: 0.7rem; border-start-end-radius: 0.7rem;">
                        <button class="btn btn-blue px-4 rounded-0" style="height: 60px;"><i
