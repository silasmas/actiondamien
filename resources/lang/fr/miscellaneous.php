    ...
    */
    ...
    'inner_page' => [
        ...
        'sensibilization' => [
            ...
            'paragraph5' => 'Grâce aux tests réalisés plusieurs fois par les infirmiers du CEDA et ceux du centre hospitalier de Kabinda chez les Médecin Sans Frontières, le tableau médical présentait que notre patient était atteint aux poumons, un antécédent du VIH dont il souffrait, en réalité.',
            'paragraph6' => 'C\'est ainsi qu\'il fut placé sous antirétroviraux, un traitement destiné aux personnes vivant avec le VIH/SIDA.',
            'paragraph7' => 'En date du 22 janvier 2021, Mardochée avait été mis sous traitement de la tuberculose ultrarésistante, et plus tard, il fut atteint de la dyspnée, qui est une difficulté respiratoire. Il fut placé sous oxygène jusqu\'à la fin de son traitement.',
            'paragraph8' => 'Toujours optimiste et fort, il fut ramené en famille après une longue période de traitement le 24 décembre 2022, doté d\'un concentrateur, don de l\'action Damien. Cet appareil lui permettait de mieux respirer. En effet, il était qualifié d\'oxygéno-dépendant. Il a également reçu un groupe électrogène et une Nintendo comme Kit de survie.',
            'paragraph9' => 'Ramené au CEDA deux semaines après sa sortie soit un certain 8 janvier 2022 dans un état de détresse, Mardochée reçut des soins de qualités avec amour et il était plein d\'espoir pour son rétablissement.',
            'paragraph10' => 'Telles sont en effet, les valeurs de l\'action Damien que le CEDA promeut et qui sont mises en pratique par Don Jean N\'SUELA, infirmier des consultations externes du CEDA.',
            'paragraph11' => 'Cependant, après trois mois de souffrance, sous oxygène, le jeune Mardoché rendit l\'âme le 02 Avril 2022.',
            'paragraph12' => 'Il fut soigné, soutenu et accompagné jusqu\'à sa dernière demeure par les infirmiers du CEDA et par quelques membres de sa famille.',
            'paragraph13' => 'Soulignons pour terminer que chaque année, nous avons davantage de succès stories que de décès.',
            'paragraph14' => 'A travers l\'histoire du jeune Kuniungina Batona Mardochée, nous avons tenu à mettre en lumière, tous les efforts fournis pour le soigner, le couvrir d\'affection et l\'accompagner dans sa dernière demeure.',
            'paragraph15' => 'C\'est une histoire parmi tant d\'autres, qui donne un aperçu sur le travail que nous faisons auprès des malades que nous recevons.',
        ],
        // Projects
        'projects' => [
